...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'avro_case.converter' => 'getAvroCase_ConverterService',
            'avro_case.twig.extension' => 'getAvroCase_Twig_ExtensionService',
            'avro_csv.exporter' => 'getAvroCsv_ExporterService',
            'avro_csv.field_retriever' => 'getAvroCsv_FieldRetrieverService',
            'avro_csv.importer' => 'getAvroCsv_ImporterService',
            'avro_csv.reader' => 'getAvroCsv_ReaderService',
            'avro_csv.writer' => 'getAvroCsv_WriterService',
            'bacloo_login_listener' => 'getBaclooLoginListenerService',
            'bacloo_user.profile.form.type' => 'getBaclooUser_Profile_Form_TypeService',
            'bacloo_user.registration.form.type' => 'getBaclooUser_Registration_Form_TypeService',
            ...
            'payum.extension.storage.bacloo_paymentbundle_entity_payment' => 'getPayum_Extension_Storage_BaclooPaymentbundleEntityPaymentService',
            ...
            'payum.storage.bacloo_paymentbundle_entity_payment' => 'getPayum_Storage_BaclooPaymentbundleEntityPaymentService',
            'payum.storage.bacloo_paymentbundle_entity_paymenttoken' => 'getPayum_Storage_BaclooPaymentbundleEntityPaymenttokenService',
    ...
    /**
     * Gets the public 'avro_case.converter' shared service.
     *
     * @return \Avro\CaseBundle\Util\CaseConverter
     */
    protected function getAvroCase_ConverterService()
    {
        return $this->services['avro_case.converter'] = new \Avro\CaseBundle\Util\CaseConverter();
    }

    /**
     * Gets the public 'avro_case.twig.extension' shared service.
     *
     * @return \Avro\CaseBundle\Twig\Extension\CaseExtension
     */
    protected function getAvroCase_Twig_ExtensionService()
    {
        return $this->services['avro_case.twig.extension'] = new \Avro\CaseBundle\Twig\Extension\CaseExtension($this->get('avro_case.converter'));
    }

    /**
     * Gets the public 'avro_csv.exporter' shared service.
     *
     * @return \Avro\CsvBundle\Export\Doctrine\ORM\Exporter
     */
    protected function getAvroCsv_ExporterService()
    {
        return $this->services['avro_csv.exporter'] = new \Avro\CsvBundle\Export\Doctrine\ORM\Exporter($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the public 'avro_csv.field_retriever' shared service.
     *
     * @return \Avro\CsvBundle\Util\FieldRetriever
     */
    protected function getAvroCsv_FieldRetrieverService()
    {
        return $this->services['avro_csv.field_retriever'] = new \Avro\CsvBundle\Util\FieldRetriever($this->get('annotation_reader'), $this->get('avro_case.converter'));
    }

    /**
     * Gets the public 'avro_csv.importer' shared service.
     *
     * @return \Avro\CsvBundle\Import\Importer
     */
    protected function getAvroCsv_ImporterService()
    {
        return $this->services['avro_csv.importer'] = new \Avro\CsvBundle\Import\Importer($this->get('avro_csv.reader'), $this->get('debug.event_dispatcher'), $this->get('avro_case.converter'), $this->get('doctrine.orm.default_entity_manager'), 15);
    }

    /**
     * Gets the public 'avro_csv.reader' shared service.
     *
     * @return \Avro\CsvBundle\Util\Reader
     */
    protected function getAvroCsv_ReaderService()
    {
        return $this->services['avro_csv.reader'] = new \Avro\CsvBundle\Util\Reader($this->get('avro_case.converter'));
    }

    /**
     * Gets the public 'avro_csv.writer' shared service.
     *
     * @return \Avro\CsvBundle\Util\Writer
     */
    protected function getAvroCsv_WriterService()
    {
        return $this->services['avro_csv.writer'] = new \Avro\CsvBundle\Util\Writer();
    }

    /**
     * Gets the public 'bacloo_login_listener' shared service.
     *
     * @return \Bacloo\UserBundle\Listener\BaclooLoginListener
     */
    protected function getBaclooLoginListenerService()
    {
        return $this->services['bacloo_login_listener'] = new \Bacloo\UserBundle\Listener\BaclooLoginListener($this->get('fos_user.user_manager'));
    }

    /**
     * Gets the public 'bacloo_user.profile.form.type' shared service.
     *
     * @return \Bacloo\UserBundle\Form\ProfileFormType
     */
    protected function getBaclooUser_Profile_Form_TypeService()
    {
        return $this->services['bacloo_user.profile.form.type'] = new \Bacloo\UserBundle\Form\ProfileFormType();
    }

    /**
     * Gets the public 'bacloo_user.registration.form.type' shared service.
     *
     * @return \Bacloo\UserBundle\Form\RegistrationFormType
     */
    protected function getBaclooUser_Registration_Form_TypeService()
    {
        return $this->services['bacloo_user.registration.form.type'] = new \Bacloo\UserBundle\Form\RegistrationFormType('Bacloo\\UserBundle\\Entity\\User');
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('security.interactive_login', array(0 => 'bacloo_login_listener', 1 => 'onSecurityInteractiveLogin'), 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'sar', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'\\vendor\\payum\\core\\Payum\\Core\\Bridge\\Doctrine\\Resources\\mapping') => 'Payum\\Core\\Model', ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\doctrine') => 'FOS\\UserBundle\\Entity'));
        $b->setGlobalBasename('mapping');

        $c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Bacloo\\CrmBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Bacloo\\UserBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\Bacloo\\PaymentBundle\\Entity')));

        $d = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $d->addDriver($b, 'Payum\\Core\\Model');
        $d->addDriver($b, 'FOS\\UserBundle\\Entity');
        $d->addDriver($c, 'Bacloo\\CrmBundle\\Entity');
        $d->addDriver($c, 'Bacloo\\UserBundle\\Entity');
        $d->addDriver($c, 'Bacloo\\PaymentBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('payum' => 'Payum\\Core\\Model', 'BaclooCrmBundle' => 'Bacloo\\CrmBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'BaclooUserBundle' => 'Bacloo\\UserBundle\\Entity', 'PaymentBundle' => 'Bacloo\\PaymentBundle\\Entity'));
        ...
        $e->addCustomStringFunction('MATCH_AGAINST', 'Bacloo\\Extensions\\Doctrine\\MatchAgainst');
        $e->addCustomStringFunction('MONTH', 'DoctrineExtensions\\Query\\Mysql\\Month');
        $e->addCustomStringFunction('YEAR', 'DoctrineExtensions\\Query\\Mysql\\Year');
        $e->addCustomStringFunction('YEARMONTH', 'DoctrineExtensions\\Query\\Mysql\\YearMonth');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_2ade09dc16f16e1c7b6a1c88c6d3eaa3a742c2292e39b9d5c3a476e209389f30');
    ...
    {
        return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension($this, array('bacloo_user_registration' => 'bacloo_user.registration.form.type', 'bacloo_user_profile' => 'bacloo_user.profile.form.type', 'form' => 'form.type.form', 'birthday' => 'form.type.birthday', 'checkbox' => 'form.type.checkbox', 'choice' => 'form.type.choice', 'collection' => 'form.type.collection', 'country' => 'form.type.country', 'date' => 'form.type.date', 'datetime' => 'form.type.datetime', 'email' => 'form.type.email', 'file' => 'form.type.file', 'hidden' => 'form.type.hidden', 'integer' => 'form.type.integer', 'language' => 'form.type.language', 'locale' => 'form.type.locale', 'money' => 'form.type.money', 'number' => 'form.type.number', 'password' => 'form.type.password', 'percent' => 'form.type.percent', 'radio' => 'form.type.radio', 'repeated' => 'form.type.repeated', 'search' => 'form.type.search', 'textarea' => 'form.type.textarea', 'text' => 'form.type.text', 'time' => 'form.type.time', 'timezone' => 'form.type.timezone', 'url' => 'form.type.url', 'button' => 'form.type.button', 'submit' => 'form.type.submit', 'reset' => 'form.type.reset', 'currency' => 'form.type.currency', 'entity' => 'form.type.entity', 'fos_user_username' => 'fos_user.username_form_type', 'fos_user_profile' => 'fos_user.profile.form.type', 'fos_user_registration' => 'fos_user.registration.form.type', 'fos_user_change_password' => 'fos_user.change_password.form.type', 'fos_user_resetting' => 'fos_user.resetting.form.type', 'payum_credit_card_expiration_date' => 'payum.form.type.credit_card_expiration_date', 'payum_credit_card' => 'payum.form.type.credit_card', 'payum_gateway_config' => 'payum.form.type.gateway_config', 'payum_gateway_factories_choice' => 'payum.form.type.gateway_factories_choice'), array('form' => array(0 => 'form.type_extension.form.http_foundation', 1 => 'form.type_extension.form.validator', 2 => 'form.type_extension.upload.validator', 3 => 'form.type_extension.csrf', 4 => 'form.type_extension.form.data_collector'), 'repeated' => array(0 => 'form.type_extension.repeated.validator'), 'submit' => array(0 => 'form.type_extension.submit.validator')), array(0 => 'form.type_guesser.validator', 1 => 'form.type_guesser.doctrine'))), $this->get('form.resolved_type_factory'));
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => 'FOSUserBundle:Registration:email.txt.twig', 'resetting.template' => 'FOSUserBundle:Resetting:email.txt.twig', 'from_email' => array('confirmation' => array('bacloo@bacloo.fr' => 'Bacloo'), 'resetting' => array('bacloo@bacloo.fr' => 'Bacloo'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form'] = $this->get('form.factory')->createNamed('fos_user_profile_form', 'bacloo_user_profile', NULL, array('validation_groups' => array(0 => 'Profile', 1 => 'Default')));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Bacloo\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form'] = $this->get('form.factory')->createNamed('fos_user_registration_form', 'bacloo_user_registration', NULL, array('validation_groups' => array(0 => 'Registration', 1 => 'Default')));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Bacloo\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Bacloo\\UserBundle\\Entity\\User');
    }
    ...
    /**
     * Gets the public 'payum.action.obtain_credit_card' shared service.
     *
     * @return \Payum\Core\Bridge\Symfony\Action\ObtainCreditCardAction
     */
    ...
    /**
     * Gets the public 'payum.buzz.client' shared service.
     *
     * @return \Buzz\Client\ClientInterface
     */
    protected function getPayum_Buzz_ClientService()
    {
        $this->services['payum.buzz.client'] = $instance = \Payum\Core\Bridge\Buzz\ClientFactory::createCurl();
    ...
    /**
     * Gets the public 'payum.custom.factory' shared service.
     *
     * @return \Payum\Bundle\PayumBundle\FixedGatewayFactory
     */
    protected function getPayum_Custom_FactoryService()
    {
        return $this->services['payum.custom.factory'] = new \Payum\Bundle\PayumBundle\FixedGatewayFactory(array('payum.factory_name' => 'custom', 'payum.template.layout' => '@PayumCore\\layout.html.twig', 'payum.template.obtain_credit_card' => '@PayumSymfonyBridge\\obtainCreditCard.html.twig', 'buzz.client' => $this->get('payum.buzz.client'), 'twig.env' => $this->get('twig'), 'payum.iso4217' => $this->get('payum.iso4217')), $this->get('payum.gateway_factory'));
    }
    ...
    /**
     * Gets the public 'payum.extension.storage.bacloo_paymentbundle_entity_payment' shared service.
     *
     * @return \Payum\Core\Extension\StorageExtension
     */
    protected function getPayum_Extension_Storage_BaclooPaymentbundleEntityPaymentService()
    {
        return $this->services['payum.extension.storage.bacloo_paymentbundle_entity_payment'] = new \Payum\Core\Extension\StorageExtension($this->get('payum.storage.bacloo_paymentbundle_entity_payment'));
    }

    /**
     * Gets the public 'payum.extension.token_factory' shared service.
     *
     * @return \Payum\Core\Extension\GenericTokenFactoryExtension
     */
    ...
    /**
     * Gets the public 'payum.iso4217' shared service.
     *
     * @return \Payum\ISO4217\ISO4217
     */
    ...
    /**
     * Gets the public 'payum.offline.factory' shared service.
     *
    ...
    /**
     * Gets the public 'payum.paypal_express_checkout_nvp.factory' shared service.
     *
    ...
    /**
     * Gets the public 'payum.paypal_express_checkout_nvp.paypal_express_checkout_and_doctrine_orm.gateway' shared service.
     *
     * @return \Payum\Core\Gateway
     */
    protected function getPayum_PaypalExpressCheckoutNvp_PaypalExpressCheckoutAndDoctrineOrm_GatewayService()
    {
        return $this->services['payum.paypal_express_checkout_nvp.paypal_express_checkout_and_doctrine_orm.gateway'] = $this->get('payum.paypal_express_checkout_nvp.factory')->create(array('username' => 'ringuetjm_api1.bacloo.fr', 'password' => 'NZ6VHYPQ89K2KSKT', 'signature' => 'AklwVKgp44p8duhs3UK2HU5Un7j6AV7m842TY-.drokiHHsuSQgAZZ7E', 'sandbox' => false, 'actions' => array(), 'apis' => array(), 'extensions' => array(), 'payum.gateway_name' => 'paypal_express_checkout_and_doctrine_orm'));
    }

    /**
     * Gets the public 'payum.security.http_request_verifier' shared service.
     *
    ...
    /**
     * Gets the public 'payum.security.token_factory' shared service.
     *
     * @return \Payum\Core\Security\GenericTokenFactory
     */
    ...
    {
        return $this->services['payum.security.token_storage'] = new \Payum\Core\Bridge\Doctrine\Storage\DoctrineStorage($this->get('payum.entity_manager'), 'Bacloo\\PaymentBundle\\Entity\\PaymentToken');
    }
    ...
    /**
     * Gets the public 'payum.storage.bacloo_paymentbundle_entity_payment' shared service.
     *
     * @return \Payum\Core\Bridge\Doctrine\Storage\DoctrineStorage
     */
    protected function getPayum_Storage_BaclooPaymentbundleEntityPaymentService()
    {
        return $this->services['payum.storage.bacloo_paymentbundle_entity_payment'] = new \Payum\Core\Bridge\Doctrine\Storage\DoctrineStorage($this->get('payum.entity_manager'), 'Bacloo\\PaymentBundle\\Entity\\Payment');
    }

    /**
     * Gets the public 'payum.storage.bacloo_paymentbundle_entity_paymenttoken' shared service.
     *
     * @return \Payum\Core\Bridge\Doctrine\Storage\DoctrineStorage
     */
    protected function getPayum_Storage_BaclooPaymentbundleEntityPaymenttokenService()
    {
        return $this->services['payum.storage.bacloo_paymentbundle_entity_paymenttoken'] = new \Payum\Core\Bridge\Doctrine\Storage\DoctrineStorage($this->get('payum.entity_manager'), 'Bacloo\\PaymentBundle\\Entity\\PaymentToken');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/conditions_generales');
        ...
        $m = new \Symfony\Component\Security\Http\HttpUtils($d, $d, '{^https?://%s$}i');

        $n = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($m, array());
        $n->setOptions(array('login_path' => 'fos_user_security_login', 'default_target_path' => '/accueil', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $p = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $m, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($m, '/login'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'fos_user_security_logout'));
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($l, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => new \Symfony\Component\Security\Core\User\InMemoryUserProvider(array('user' => array('password' => 'userpass', 'roles' => array(0 => 'ROLE_USER')), 'admin' => array('password' => 'adminpass', 'roles' => array(0 => 'ROLE_ADMIN')))), 1 => $this->get('fos_user.user_provider.username')), 'main', $a, $c), 2 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, $this->get('security.authentication.session_strategy'), $m, 'main', $n, $o, array('check_path' => 'fos_user_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, NULL), 3 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '63728439c20ee6.99681859', $a, $f), 4 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $l, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $m, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $m, 'fos_user_security_login', false), NULL, NULL, $a, false), $p);
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig\Environment($this->get('twig.loader'), array('paths' => array(($this->targetDirs[3].'\\vendor\\payum\\core\\Payum\\Core/Resources/views') => 'PayumCore', ($this->targetDirs[3].'\\vendor\\payum\\core\\Payum\\Core\\Bridge\\Symfony/Resources/views') => 'PayumSymfonyBridge'), 'debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig'), 'autoescape' => 'name', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
        ...
        $instance->addExtension($this->get('avro_case.twig.extension'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Bacloo\\CrmBundle/Resources/views'), 'BaclooCrm');
        $instance->addPath(($this->targetDirs[3].'\\src\\Bacloo\\UserBundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\Bacloo\\UserBundle/Resources/views'), 'BaclooUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\Bacloo\\PaymentBundle/Resources/views'), 'Payum');
        $instance->addPath(($this->targetDirs[3].'\\src\\Bacloo\\PaymentBundle/Resources/views'), 'Payment');
        $instance->addPath(($this->targetDirs[3].'\\src\\Avro\\CsvBundle/Resources/views'), 'AvroCsv');
    ...
    /**
     * Gets the public 'white_october.tcpdf' shared service.
     *
    ...
    protected function getWhiteOctober_TcpdfService()
    {
        ...
        return $this->services['white_october.tcpdf'] = new \WhiteOctober\TCPDFBundle\Controller\TCPDFController('Bacloo\\CrmBundle\\Controller\\maclasspdf');
    }
    ...
    /**
     * Gets the private 'payum.entity_manager' shared service.
     *
     * @return \Doctrine\ORM\EntityManager
     */
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'BaclooCrmBundle' => 'Bacloo\\CrmBundle\\BaclooCrmBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'BaclooUserBundle' => 'Bacloo\\UserBundle\\BaclooUserBundle',
                'PayumBundle' => 'Payum\\Bundle\\PayumBundle\\PayumBundle',
                'PaymentBundle' => 'Bacloo\\PaymentBundle\\PaymentBundle',
                'AvroCsvBundle' => 'Avro\\CsvBundle\\AvroCsvBundle',
                'AvroCaseBundle' => 'Avro\\CaseBundle\\AvroCaseBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'BaclooCrmBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\Bacloo\\CrmBundle'),
                    'namespace' => 'Bacloo\\CrmBundle',
                ),
                'FOSUserBundle' => array(
                    'parent' => NULL,
                ...
                'BaclooUserBundle' => array(
                    'parent' => 'FOSUserBundle',
                    'path' => ($this->targetDirs[3].'\\src\\Bacloo\\UserBundle'),
                ...
                'PaymentBundle' => array(
                    'parent' => 'PayumBundle',
                    'path' => ($this->targetDirs[3].'\\src\\Bacloo\\PaymentBundle'),
                    'namespace' => 'Bacloo\\PaymentBundle',
                ),
                'AvroCsvBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\Avro\\CsvBundle'),
                    'namespace' => 'Avro\\CsvBundle',
                ),
                'AvroCaseBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\Avro\\CaseBundle'),
                ...
                'WhiteOctoberTCPDFBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\vendor\\whiteoctober\\tcpdf-bundle'),
            ...
            'paypal.express_checkout.username' => 'ringuetjm_api1.bacloo.fr',
            'paypal.express_checkout.password' => 'NZ6VHYPQ89K2KSKT',
            'paypal.express_checkout.signature' => 'AklwVKgp44p8duhs3UK2HU5Un7j6AV7m842TY-.drokiHHsuSQgAZZ7E',
            ...
            'swiftmailer.mailer.default.transport.smtp.port' => '',
            'swiftmailer.mailer.default.transport.smtp.host' => '',
            ...
            'fos_user.model.user.class' => 'Bacloo\\UserBundle\\Entity\\User',
            'fos_user.template.engine' => 'twig',
            'fos_user.profile.form.type' => 'bacloo_user_profile',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'bacloo@bacloo.fr' => 'Bacloo',
            ),
            'fos_user.registration.confirmation.enabled' => false,
            'fos_user.registration.form.type' => 'bacloo_user_registration',
            ...
            'avro_csv.batch_size' => 15,
            'avro_csv.tmp_upload_dir' => ($this->targetDirs[2].'/../web/uploads/tmp/'),
            'avro_csv.sample_count' => 5,
            'avro_csv.objects.fiche.class' => 'Bacloo\\CrmBundle\\Entity\\Fiche',
            'avro_csv.objects.fiche.redirect_route' => 'bacloocrm_import',
            'avro_csv.objects.contact.class' => 'Bacloo\\CrmBundle\\Entity\\Bcontacts',
            'avro_csv.objects.contact.redirect_route' => 'bacloocrm_import',
            'avro_csv.objects.event.class' => 'Bacloo\\CrmBundle\\Entity\\Event',
            'avro_csv.objects.event.redirect_route' => 'bacloocrm_import',
            'avro_csv.objects.afacturer.class' => 'Bacloo\\CrmBundle\\Entity\\Afacturer',
            'avro_csv.objects.afacturer.redirect_route' => 'bacloocrm_import',
            'avro_csv.objects.factures.class' => 'Bacloo\\CrmBundle\\Entity\\Factures',
            'avro_csv.objects.factures.redirect_route' => 'bacloocrm_import',
            'avro_csv.objects.grille.class' => 'Bacloo\\CrmBundle\\Entity\\Grille',
            'avro_csv.objects.grille.redirect_route' => 'bacloocrm_importergrille',
            'avro_csv.objects.grillesl.class' => 'Bacloo\\CrmBundle\\Entity\\Grillesl',
            'avro_csv.objects.grillesl.redirect_route' => 'bacloocrm_importergrille',
            'avro_csv.objects.ca.class' => 'Bacloo\\CrmBundle\\Entity\\Factures',
            'avro_csv.objects.ca.redirect_route' => 'bacloocrm_import',
            'avro_csv.objects.calocdet.class' => 'Bacloo\\CrmBundle\\Entity\\Locataclone',
            'avro_csv.objects.calocdet.redirect_route' => 'bacloocrm_import',
            'avro_csv.objects.cavente.class' => 'Bacloo\\CrmBundle\\Entity\\Factures',
            'avro_csv.objects.cavente.redirect_route' => 'bacloocrm_import',
            'avro_csv.objects.avoirs.class' => 'Bacloo\\CrmBundle\\Entity\\Factures',
            'avro_csv.objects.avoirs.redirect_route' => 'bacloocrm_import',
            'avro_csv.objects.cacom.class' => 'Bacloo\\CrmBundle\\Entity\\Factures',
            'avro_csv.objects.cacom.redirect_route' => 'bacloocrm_import',
            'avro_csv.objects.avoirsparcom.class' => 'Bacloo\\CrmBundle\\Entity\\Factures',
            'avro_csv.objects.avoirsparcom.redirect_route' => 'bacloocrm_import',
            'avro_csv.objects.extraitcompteclient.class' => 'Bacloo\\CrmBundle\\Entity\\Factures',
            'avro_csv.objects.extraitcompteclient.redirect_route' => 'bacloocrm_import',
            'avro_csv.objects.camensuelclients.class' => 'Bacloo\\CrmBundle\\Entity\\Locataclone',
            'avro_csv.objects.camensuelclients.redirect_route' => 'bacloocrm_import',
            'avro_csv.objects.camensuelmachines.class' => 'Bacloo\\CrmBundle\\Entity\\Locationsclone',
            'avro_csv.objects.camensuelmachines.redirect_route' => 'bacloocrm_import',
            'avro_csv.objects.camensueltypemachines.class' => 'Bacloo\\CrmBundle\\Entity\\Locationsclone',
            'avro_csv.objects.camensueltypemachines.redirect_route' => 'bacloocrm_import',
            'avro_csv.objects.camensueltypemachinessl.class' => 'Bacloo\\CrmBundle\\Entity\\Locationsslclone',
            'avro_csv.objects.camensueltypemachinessl.redirect_route' => 'bacloocrm_import',
            'white_october_tcpdf.file' => ($this->targetDirs[2].'/../vendor/tecnickcom/tcpdf/tcpdf.php'),
            'white_october_tcpdf.class' => 'Bacloo\\CrmBundle\\Controller\\maclasspdf',
