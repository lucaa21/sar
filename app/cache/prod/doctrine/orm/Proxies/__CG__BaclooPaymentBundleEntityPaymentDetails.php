 ...
 */
class PaymentDetails extends \Bacloo\PaymentBundle\Entity\PaymentDetails implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'details'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PaymentDetails $proxy) {
