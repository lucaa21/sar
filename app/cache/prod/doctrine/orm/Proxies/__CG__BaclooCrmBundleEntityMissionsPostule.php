 ...
 */
class MissionsPostule extends \Bacloo\CrmBundle\Entity\MissionsPostule implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Bacloo\\CrmBundle\\Entity\\MissionsPostule' . "\0" . 'id', '' . "\0" . 'Bacloo\\CrmBundle\\Entity\\MissionsPostule' . "\0" . 'titre', '' . "\0" . 'Bacloo\\CrmBundle\\Entity\\MissionsPostule' . "\0" . 'datedebut', '' . "\0" . 'Bacloo\\CrmBundle\\Entity\\MissionsPostule' . "\0" . 'datefin', '' . "\0" . 'Bacloo\\CrmBundle\\Entity\\MissionsPostule' . "\0" . 'adresse', '' . "\0" . 'Bacloo\\CrmBundle\\Entity\\MissionsPostule' . "\0" . 'codepostal', '' . "\0" . 'Bacloo\\CrmBundle\\Entity\\MissionsPostule' . "\0" . 'ville', '' . "\0" . 'Bacloo\\CrmBundle\\Entity\\MissionsPostule' . "\0" . 'raisonsociale', '' . "\0" . 'Bacloo\\CrmBundle\\Entity\\MissionsPostule' . "\0" . 'description', '' . "\0" . 'Bacloo\\CrmBundle\\Entity\\MissionsPostule' . "\0" . 'dresscode', '' . "\0" . 'Bacloo\\CrmBundle\\Entity\\MissionsPostule' . "\0" . 'agenceid', '' . "\0" . 'Bacloo\\CrmBundle\\Entity\\MissionsPostule' . "\0" . 'profilid', '' . "\0" . 'Bacloo\\CrmBundle\\Entity\\MissionsPostule' . "\0" . 'postule', '' . "\0" . 'Bacloo\\CrmBundle\\Entity\\MissionsPostule' . "\0" . 'accepte', '' . "\0" . 'Bacloo\\CrmBundle\\Entity\\MissionsPostule' . "\0" . 'refuse', '' . "\0" . 'Bacloo\\CrmBundle\\Entity\\MissionsPostule' . "\0" . 'urgent'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MissionsPostule $proxy) {
    ...
    public function setProfilid($profilid)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setProfilid', [$profilid]);

        return parent::setProfilid($profilid);
    }
    ...
    public function getProfilid()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getProfilid', []);

        return parent::getProfilid();
    }
    ...
    public function setPostule($postule)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPostule', [$postule]);

        return parent::setPostule($postule);
    }
    ...
    public function getPostule()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPostule', []);

        return parent::getPostule();
    }
    ...
    public function setAccepte($accepte)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAccepte', [$accepte]);

        return parent::setAccepte($accepte);
    }
    ...
    public function setRefuse($refuse)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRefuse', [$refuse]);

        return parent::setRefuse($refuse);
    }
    ...
    public function getRefuse()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRefuse', []);

        return parent::getRefuse();
    }
