...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['avro_csv.importer'] = new \Avro\CsvBundle\Import\Importer($this->get('avro_csv.reader'), $this->get('event_dispatcher'), $this->get('avro_case.converter'), $this->get('doctrine.orm.default_entity_manager'), 15);
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_f94036c0e61b978d2df0a97ae6142155b55ab9cca3fef826542d089461b9aae5');
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig\Environment($this->get('twig.loader'), array('paths' => array(($this->targetDirs[3].'\\vendor\\payum\\core\\Payum\\Core/Resources/views') => 'PayumCore', ($this->targetDirs[3].'\\vendor\\payum\\core\\Payum\\Core\\Bridge\\Symfony/Resources/views') => 'PayumSymfonyBridge'), 'debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig'), 'autoescape' => 'name', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
