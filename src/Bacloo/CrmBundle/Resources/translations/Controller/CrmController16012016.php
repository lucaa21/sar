...
// echo 'fonctionne';
			...
			//Partie liste besoins
				...
				elseif(!empty($besoins))//Si la fiche a des besoins renseignés
				{
...
// echo 'fonctionne';
			...
			//Partie liste besoins
				...
				elseif(!empty($tabactivite))//Si la fiche a des besoins renseignés
				{
					//Ménage si tags actualisés
					//echo 'adadaooooooo';
					// $tagsfiche  = $em->getRepository('BaclooCrmBundle:Fiche')		
...
//Gros check des modules
		...
		if(empty($modules))
		{
			if($user->getId() < 238)
			{
				...
				$modules->setModule2('Relances", "Rendez-vous" et "Tâches');
